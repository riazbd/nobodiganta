export default function Icon({ name, size = 16, style = {} }) {
  ...
  const icons = {
    ...
    sparkles: (
      <svg style={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m12 3 1.912 5.886 6.176.014-4.99 3.633 1.904 5.887L12 14.8l-5.002 3.62 1.904-5.887-4.99-3.633 6.176-.014L12 3z" />
      </svg>
    ),
    star: (
      <svg style={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    trendingDown: (
      <svg style={s} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <polyline points="23 18 13.5 7 8.5 12.5 1 5" />
