...
function ArticleCard({ item, lang, onNavigate, hero = false }) {
  ...
  return (
    ...
    >
      <ArticleThumb src={item.featured_image} alt={item.title} isVideo={item.article_type === 'video'} aspectRatio={hero ? '16/9' : '4/3'} style={hero ? { width: '100%', maxHeight: 420 } : undefined} />
      <div className="cb">
        <h3>{item.title}</h3>
