        ...
        <div>
          <div className="sec" style={{ marginBottom: 18 }}>
            ...
            <div style={{ fontFamily: "'Kalpurush','SolaimanLipi',sans-serif", fontSize: 15, lineHeight: 1.9, color: '#2a2a2a' }}>
              <p style={{ marginBottom: 16 }}>{lang === 'bn'
                ? `${siteName} বাংলাদেশের একটি বাংলা ভাষার দৈনিক সংবাদপত্র। এটি ২০১০ সালের ১ জানুয়ারি প্রথম প্রকাশিত হয়। শহীদুল ইসলামের সম্পাদনায় এবং ${siteName} মিডিয়া লিমিটেডের প্রকাশনায় এই পত্রিকাটি বর্তমানে বাংলাদেশের সর্বাধিক প্রচারিত বাংলা দৈনিক।`
                : `${siteName} is a Bengali-language daily newspaper of Bangladesh. It was first published on January 1, 2010. Under the editorship of Shahidul Islam and published by ${siteName} Media Limited, this newspaper is currently the most widely circulated Bengali daily in Bangladesh.`}
              </p>
              <p style={{ marginBottom: 16 }}>{lang === 'bn'
                ? 'পত্রিকাটি সত্য, নিরপেক্ষতা ও পেশাদারিত্বের নীতিতে প্রতিদিনের সংবাদ পরিবেশন করে থাকে। বাংলাদেশের পাশাপাশি পশ্চিমবঙ্গসহ বিশ্বের বিভিন্ন দেশে বাংলাভাষী পাঠকদের কাছে পত্রিকাটি সমানভাবে জনপ্রিয়।'
                : 'The newspaper delivers daily news based on the principles of truth, impartiality, and professionalism. Alongside Bangladesh, the newspaper is equally popular among Bengali-speaking readers in West Bengal and various countries around the world.'}
              </p>
              <p style={{ marginBottom: 16 }}>{lang === 'bn'
                ? `ডিজিটাল প্ল্যাটফর্মে ${siteName}-র ওয়েবসাইট বাংলাদেশের সর্বাধিক পঠিত বাংলা সংবাদ পোর্টাল। মোবাইল অ্যাপ, সোশ্যাল মিডিয়া ও ই-পেপারের মাধ্যমে পাঠকদের সঙ্গে নিরন্তর যোগাযোগ বজায় রাখে ${siteName}।`
                : `On digital platforms, ${siteName}'s website is Bangladesh's most read Bengali news portal. ${siteName} maintains continuous communication with readers through mobile app, social media, and e-paper.`}
              </p>
            </div>
          </div>
          <div className="sec" style={{ marginBottom: 18 }}>
