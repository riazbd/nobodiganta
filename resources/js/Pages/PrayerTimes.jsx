              ...
              {weather ? (
                <>
                  ...
                  <dl className="almnc-wx-dl">
                    ...
                    <div><dt>{lang === 'bn' ? 'বাতাস' : 'Wind'}</dt><dd>{lang === 'bn' ? toBn(String(Math.round(weather.current.wind_kph))) : Math.round(weather.current.wind_kph)} {lang === 'bn' ? 'কিমি/ঘণ্টা' : 'km/h'}</dd></div>
