    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'group' => 'breaking', 'type' => 'boolean',
                'label_bn' => 'অ্যালার্ট ব্যানার চালু', 'label_en' => 'Alert banner enabled',
                'description_bn' => 'চালু থাকলে পিন করা ব্রেকিং আইটেম স্ক্রলের উপরে একটি টিভি-স্টাইল অ্যালার্ট ব্যানার হিসেবে নির্দিষ্ট বিরতিতে ফ্ল্যাশ করবে।',
                'description_en' => 'When on, pinned breaking items flash in as a TV-style alert banner above the scroll at a set interval.',
                'is_public' => true,
            ],
            [
                'key' => 'breaking_alert_seconds', 'value' => '8',
                'group' => 'breaking', 'type' => 'number',
                'label_bn' => 'প্রতি অ্যালার্ট শিরোনামের সময় (সেকেন্ড)', 'label_en' => 'Seconds per alert headline',
                'description_bn' => 'প্রতিবার অ্যালার্ট দেখানোর সময় প্রতিটি শিরোনাম কত সেকেন্ড দৃশ্যমান থাকবে।',
                'description_en' => 'How long each headline stays visible each time the alert banner appears.',
                'is_public' => true,
            ],
            [
                ...
                'description_bn' => 'প্রতিবার অ্যালার্ট দেখানোর সময় পিন করা শিরোনামগুলো কতবার দেখানো হবে।',
                'description_en' => 'How many times to loop through the pinned headlines on each appearance.',
                'is_public' => true,
            ],
            [
                'key' => 'breaking_alert_interval_minutes', 'value' => '5',
                'group' => 'breaking', 'type' => 'number',
                'label_bn' => 'অ্যালার্ট বিরতি (মিনিট)', 'label_en' => 'Alert interval (minutes)',
